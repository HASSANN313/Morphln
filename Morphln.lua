...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./Morphln.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("FX", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Morphln -X kill
screen -S Morphln ./Morphln
done
]])  
file:close() 
...
local Morphln_Msg = ''  
if msgs < 100 then 
Morphln_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Morphln_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Morphln_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Morphln_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Morphln_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Morphln_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Morphln_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Morphln_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Morphln_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Morphln_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Morphln_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Morphln_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
Morphln_Msg = 'رب التفاعل'  
end 
return Morphln_Msg 
end
...
function plugin_Morphlnx(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.Morphlnx and msg then
pre_msg = plugin.Morphlnx(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceMorphln(msg,data) -- بداية العمل
if msg then
...
os.execute('rm -rf Morphln.lua')
os.execute('wget https://raw.githubusercontent.com/HASSANN313/Morphln/master/Morphln.lua')
...
--------------------------------------------------------------------------------------------------------------
if Morphln_Msg and not Special(msg) then  
local Morphln_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Morphln_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
send(msg.chat_id_, msg.id_,' ◐ تمِہ تـ؏ـطيل ࢦڪࢪۅپ .')
else
sendText(msg.chat_id_,'\n◐ ۿۧهلا ﮼حِۢـياتيہ ~ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ◐ تمِہ تـ؏ـطيل ࢦڪࢪۅپ .{'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
os.execute('rm -rf Morphln.lua')
os.execute('wget https://raw.githubusercontent.com/Source-Morphln/Morphln/master/Morphln.lua')
send(msg.chat_id_, msg.id_,' ↫ تم تحديث السورس \n ◐ لديك اخر اصدار لسورس فوكس ₂₀₂₁\n ◐ الاصدار ↫ F𝗼𝘅₁')
dofile('Morphln.lua')  
end
...
Text = [[
*ʜɪ ғᴏx*
◐ ۿݪأ ؏َـمݛي بـ سـۅࢪس فـۅڪس¹
𝘊𝘩 - [𝖋𝖔𝖝  𓅛](t.me/IIIIlI8) ◐
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text='⌯ 𝗧𝗘𝗺 𝗙𝗢𝗫 ',url="t.me/IIIIlI8"},
},
{
{text='𝗠𝗢𝗥𝗣𝗛𝗜𝗡𝗘',url="t.me/ii_t3"},
},
{
{text=' 𝘋𝘈𝘝 ',url="t.me/X_GGX"},
},
{
{text='πشروحات السورس',url="t.me/x4444s"},
},
{
...
keyboard.inline_keyboard = {
{
{text = 'رابط حذف التلكرام',url="https://my.telegram.org/auth?to=delete"},
},
{
...
function Function_Morphln(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Morphln, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Morphln, nil)
return false 
end
...
database:set(bot_id.."Morphln1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Morphln1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"* ◐ ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."Morphln1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Morphln1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Morphln1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Morphln1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"* ◐ تم منع الكلمه مع التحذير*")  
database:del(bot_id.."Morphln1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Morphln1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Morphln1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Morphln1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"* ◐ ارسل الكلمه الان*")  
database:set(bot_id.."Morphln1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Morphln1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Morphln1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Morphln1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Morphln1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Morphln1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Morphln1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Morphln1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Morphln1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n *◐ قائمة المنع \n*◐○◐○◐○◐○◐ٴ*\n*"
for k,v in pairs(list) do  
local Morphln_Msg = database:get(bot_id.."Morphln1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..Morphln_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == ("تاك") or text == ("منشن") and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'فوكس')
send(msg.chat_id_, msg.id_,'*اسميہ  '..Namebot..'*')
end
...
send(msg.chat_id_, msg.id_,'* ◐ عدد الكروبات الان » { '..#group..' }'..Morphlnk..''..Morphln..'\n*- الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n*')   
end
end
end,nil)
end
...
-- vardump(data) 
Morphlndx(msg.chat_id_, msg.id_, ' ◐ ايدي المجموعة » ( '..msg.chat_id_..' )\n ◐ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ◐ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ◐ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == "راسلني" then
rpl = {"ها هلاو","انطق","","تحب الحلفي @X_GGX"};
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ 𝗧𝗘𝗺 𝗙𝗢𝗫 ♔︎',url="t.me/IIIIlI8"}},
}
local msg_id = msg.id_/2097152/0.5
...
Morphln = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Morphln)
...
--------------------------------------------------------------------------------------------------------------
SourceMorphln(data.message_,data)
plugin_Morphlnx(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local MorphlnAbot = database:get(bot_id.."Morphln1:Add:Filter:Rp2"..text..result.chat_id_)   
if MorphlnAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ◐ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ◐ ["..MorphlnAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Morphln1_Msg = database:get(bot_id.."Morphln1:Add:Filter:Rp2"..text..result.chat_id_)   
if Morphln1_Msg then    
send(msg.chat_id_, msg.id_," ◐ "..Morphln1_Msg)
